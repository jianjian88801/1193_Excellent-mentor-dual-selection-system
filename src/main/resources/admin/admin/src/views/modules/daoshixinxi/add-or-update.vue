<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="所教科目" prop="suojiaokemu">
          <el-input v-model="ruleForm.suojiaokemu" 
              placeholder="所教科目" clearable  :readonly="ro.suojiaokemu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="所教科目" prop="suojiaokemu">
              <el-input v-model="ruleForm.suojiaokemu" 
                placeholder="所教科目" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
            ...
            <el-col :span="24">
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.gerenjianjie" label="个人简介" prop="gerenjianjie">
                    <span>{{ruleForm.gerenjianjie}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
