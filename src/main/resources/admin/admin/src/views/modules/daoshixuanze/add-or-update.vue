<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="选择时间" prop="xuanzeshijian">
            <el-date-picker
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.xuanzeshijian" label="选择时间" prop="xuanzeshijian">
              <el-input v-model="ruleForm.xuanzeshijian" 
                placeholder="选择时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="选择内容" prop="xuanzeneirong">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="选择内容"
                  v-model="ruleForm.xuanzeneirong" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.xuanzeneirong" label="选择内容" prop="xuanzeneirong">
                    <span>{{ruleForm.xuanzeneirong}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  created() {
	this.ruleForm.xuanzeshijian = this.getCurDateTime()
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xuanzeshijian = true;
          ...
          if(o=='xuanzeneirong'){
            this.ruleForm.xuanzeneirong = obj[o];
	    this.ro.xuanzeneirong = true;
            continue;
          }
          if(o=='xuehao'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `daoshixuanze/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.daoshixuanzeCrossAddOrUpdateFlag = false;
                  this.parent.search();
