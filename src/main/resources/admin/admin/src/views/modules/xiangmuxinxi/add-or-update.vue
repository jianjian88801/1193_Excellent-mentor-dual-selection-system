<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="附件" prop="fujian">
          <file-upload
          tip="点击上传附件"
          action="file/upload"
          :limit="1"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.fujian" label="附件" prop="fujian">
            <el-button type="text" size="small" @click="download(ruleForm.fujian)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="项目要求" prop="xiangmuyaoqiu">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="项目要求"
                  v-model="ruleForm.xiangmuyaoqiu" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.xiangmuyaoqiu" label="项目要求" prop="xiangmuyaoqiu">
                    <span>{{ruleForm.xiangmuyaoqiu}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xueshengxingming = true;
          ...
          if(o=='xiangmuyaoqiu'){
            this.ruleForm.xiangmuyaoqiu = obj[o];
	    this.ro.xiangmuyaoqiu = true;
            continue;
          }
          if(o=='fujian'){
    ...
    xuehaoChange () {
      this.$http({
        url: `follow/xueyuan/xuehao?columnValue=`+ this.ruleForm.xuehao,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
