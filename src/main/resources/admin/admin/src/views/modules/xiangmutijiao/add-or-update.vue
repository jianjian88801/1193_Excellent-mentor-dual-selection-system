<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="项目文件" prop="xiangmuwenjian">
          <file-upload
          tip="点击上传项目文件"
          action="file/upload"
          :limit="1"
          :multiple="true"
          :fileUrls="ruleForm.xiangmuwenjian?ruleForm.xiangmuwenjian:''"
          @change="xiangmuwenjianUploadChange"
          ></file-upload>
        </el-form-item>  
        <div v-else>
          <el-form-item v-if="ruleForm.xiangmuwenjian" label="项目文件" prop="xiangmuwenjian">
            <el-button type="text" size="small" @click="download(ruleForm.xiangmuwenjian)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="项目内容" prop="xiangmuneirong">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.xiangmuneirong" label="项目内容" prop="xiangmuneirong">
                    <span>{{ruleForm.xiangmuneirong}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jiaoshixingming = true;
          ...
          if(o=='xiangmuwenjian'){
            this.ruleForm.xiangmuwenjian = obj[o];
	    this.ro.xiangmuwenjian = true;
            continue;
          }
          if(o=='xiangmuneirong'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `xiangmutijiao/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.xiangmutijiaoCrossAddOrUpdateFlag = false;
                  this.parent.search();
    ...
    xiangmuwenjianUploadChange(fileUrls) {
	this.ruleForm.xiangmuwenjian = fileUrls;
			this.addEditUploadStyleChange()
    },
	addEditStyleChange() {
	  this.$nextTick(()=>{
