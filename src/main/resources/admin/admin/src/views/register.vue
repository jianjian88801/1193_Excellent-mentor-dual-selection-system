  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255,255,255,.5);borderRadius:20px">
        <h1 class="h1" style="color:#000;fontSize:26px;">卓越导师双选系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="学号" class="input" v-if="tableName=='xueyuan'">
			...
			<el-form-item label="学生姓名" class="input" v-if="tableName=='xueyuan'">
			...
			<el-form-item label="工号" class="input" v-if="tableName=='daoshi'">
			...
			<el-form-item label="教师姓名" class="input" v-if="tableName=='daoshi'">
			...
			<el-form-item label="电话" class="input" v-if="tableName=='daoshi'">
...
export default {
  ...
  methods: {
    ...
    // 注册
    login() {
      if((!this.ruleForm.xuehao) && `xueyuan` == this.tableName){
      ...
      if((!this.ruleForm.gonghao) && `daoshi` == this.tableName){
      ...
      if(`daoshi` == this.tableName && this.ruleForm.dianhua&&(!this.$validate.isMobile(this.ruleForm.dianhua))){
