 ...
 */
public class DaoshixuanzeModel  implements Serializable {
	...
	public void setXuanzeneirong(String xuanzeneirong) {
		this.xuanzeneirong = xuanzeneirong;
	}
	
	/**
	 * 获取：选择内容
	 */
	public String getXuanzeneirong() {
